...
#ifndef CHARTKLINEVIEW_SWIFT_H
#define CHARTKLINEVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ChartKLineView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14ChartKLineView19AnimatedViewPortJob")
...
SWIFT_CLASS("_TtC14ChartKLineView19AnimatedMoveViewJob")
...
SWIFT_CLASS("_TtC14ChartKLineView19AnimatedZoomViewJob")
...
@property (nonatomic, copy) NSArray<UIColor *> * _Nullable labelTextColors;
...
/// 强制指定 entries, 不再自动计算坐标轴标签位置
@property (nonatomic) BOOL forceEntriesEnabled;
...
SWIFT_CLASS("_TtC14ChartKLineView9ChartData")
...
@property (nonatomic, strong) NSNumber * _Nullable drawMaxMinValueEnabled;
...
SWIFT_CLASS("_TtC14ChartKLineView35BarLineScatterCandleBubbleChartData")
...
SWIFT_CLASS("_TtC14ChartKLineView12BarChartData")
...
SWIFT_CLASS("_TtC14ChartKLineView18ChartDataEntryBase")
...
SWIFT_CLASS("_TtC14ChartKLineView14ChartDataEntry")
...
SWIFT_CLASS("_TtC14ChartKLineView17BarChartDataEntry")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView17ChartDataProvider_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView43BarLineScatterCandleBubbleChartDataProvider_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView20BarChartDataProvider_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView13IChartDataSet_")
@protocol IChartDataSet
...
/// 是否允许x轴的动画
@property (nonatomic) BOOL animateXEnable;
@end


SWIFT_PROTOCOL("_TtP14ChartKLineView39IBarLineScatterCandleBubbleChartDataSet_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView16IBarChartDataSet_")
...
SWIFT_CLASS("_TtC14ChartKLineView16ChartBaseDataSet")
...
SWIFT_CLASS("_TtC14ChartKLineView12ChartDataSet")
...
SWIFT_CLASS("_TtC14ChartKLineView38BarLineScatterCandleBubbleChartDataSet")
...
SWIFT_CLASS("_TtC14ChartKLineView15BarChartDataSet")
...
SWIFT_CLASS("_TtC14ChartKLineView16BarChartRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView8NSUIView")
...
SWIFT_CLASS("_TtC14ChartKLineView13ChartViewBase")
...
@class CustomChartDataSet;
@class CustomChartDataEntry;
@class CustomDrawChartData;
@protocol ChartViewCustomDrawDelegate;
@class UIGestureRecognizer;

/// Base-class of LineChart, BarChart, ScatterChart and CandleStickChart.
SWIFT_CLASS("_TtC14ChartKLineView20BarLineChartViewBase")
...
@property (nonatomic) BOOL drawingCustomLine;
@property (nonatomic, strong) CustomChartDataSet * _Nullable drawingDataSet;
@property (nonatomic) BOOL editingCustomLine;
@property (nonatomic, strong) CustomChartDataEntry * _Nullable drawingEntry;
/// 承载绘图的数据
@property (nonatomic, strong) CustomDrawChartData * _Nonnull customLineData;
/// delegate to receive chart events
@property (nonatomic, weak) id <ChartViewCustomDrawDelegate> _Nullable customDrawDelegate;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)initialize;
- (void)observeValueForKeyPath:(NSString * _Nullable)keyPath ofObject:(id _Nullable)object change:(NSDictionary<NSKeyValueChangeKey, id> * _Nullable)change context:(void * _Nullable)context;
...
SWIFT_CLASS("_TtC14ChartKLineView12BarChartView")
...
SWIFT_CLASS("_TtC14ChartKLineView16ChartHighlighter")
...
@interface BarLineChartViewBase (SWIFT_EXTENSION(ChartKLineView))
@property (nonatomic) BOOL isDrawContinue;
@end
...
///
- (void)appendNewDrawingWithDataSet:(CustomChartDataSet * _Nonnull)dataSet;
/// 当前是否需要拦截手势，当前触摸点是否在自定义画图上
@property (nonatomic, readonly) BOOL touchInCustomLine;
- (void)customChartDataUndo;
/// 前进操作
- (void)customChartDataRedo;
/// 是否可以撤销
@property (nonatomic, readonly) BOOL undoEnable;
/// 是否可以前进
@property (nonatomic, readonly) BOOL redoEnable;
/// 重新保存当前的自定义划线数据
- (void)updateCustomChartData;
/// 删除撤销状态
- (void)removeCustomChartDataUndoState;
- (void)nsuiTouchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)nsuiTouchesMoved:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)nsuiTouchesEnded:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)nsuiTouchesCancelled:(NSSet<UITouch *> * _Nullable)touches withEvent:(UIEvent * _Nullable)event;
...
SWIFT_CLASS("_TtC14ChartKLineView15BubbleChartData")
...
SWIFT_CLASS("_TtC14ChartKLineView20BubbleChartDataEntry")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView23BubbleChartDataProvider_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView19IBubbleChartDataSet_")
...
SWIFT_CLASS("_TtC14ChartKLineView18BubbleChartDataSet")
...
SWIFT_CLASS("_TtC14ChartKLineView19BubbleChartRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView15BubbleChartView")
...
SWIFT_CLASS("_TtC14ChartKLineView15CandleChartData")
...
SWIFT_CLASS("_TtC14ChartKLineView20CandleChartDataEntry")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView23CandleChartDataProvider_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView35ILineScatterCandleRadarChartDataSet_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView19ICandleChartDataSet_")
...
SWIFT_CLASS("_TtC14ChartKLineView34LineScatterCandleRadarChartDataSet")
...
SWIFT_CLASS("_TtC14ChartKLineView18CandleChartDataSet")
...
@interface CandleChartDataSet (SWIFT_EXTENSION(ChartKLineView))
/// objc_get/setAssociatedObject()来填充其 get 和 set
@property (nonatomic) BOOL drawJump;
@property (nonatomic) BOOL drawAction;
@end
...
SWIFT_CLASS("_TtC14ChartKLineView24CandleStickChartRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView20CandleStickChartView")
...
SWIFT_CLASS("_TtC14ChartKLineView19ChartColorTemplates")
...
@interface ChartDataEntry (SWIFT_EXTENSION(ChartKLineView))
...
@property (nonatomic) double warning;
@property (nonatomic) double volume;
@property (nonatomic) BOOL action;
@property (nonatomic) double timestamp;
@property (nonatomic, copy) NSString * _Nullable tradeMark;
@property (nonatomic) NSInteger actionType;
@property (nonatomic, copy) NSString * _Nullable actionDes;
@property (nonatomic) NSInteger magicPoint;
@end



@interface ChartDataEntryBase (SWIFT_EXTENSION(ChartKLineView))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface ChartDataSet (SWIFT_EXTENSION(ChartKLineView))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic) double dataSetCountDiff;
@end
...
SWIFT_CLASS("_TtC14ChartKLineView14ChartLimitLine")
...
@interface ChartLimitLine (SWIFT_EXTENSION(ChartKLineView))
/// objc_get/setAssociatedObject()来填充其 get 和 set
@property (nonatomic) BOOL drawLineEnable;
@end



SWIFT_PROTOCOL("_TtP14ChartKLineView27ChartViewCustomDrawDelegate_")
@protocol ChartViewCustomDrawDelegate
@optional
- (void)customDrawLocationChanged:(CGPoint)location;
- (void)customDrawActionCompleted:(CustomDrawChartData * _Nonnull)customData dataSet:(CustomChartDataSet * _Nonnull)dataSet;
- (void)customDrawDataSetDidSelected:(CustomChartDataSet * _Nonnull)dataSet;
- (void)customDrawDataSetDesSelected;
@end


SWIFT_PROTOCOL("_TtP14ChartKLineView17ChartViewDelegate_")
@protocol ChartViewDelegate
@optional
...
- (void)chartViewBeginPanning:(ChartViewBase * _Nonnull)chartView;
...
SWIFT_PROTOCOL("_TtP14ChartKLineView14IShapeRenderer_")
...
SWIFT_CLASS("_TtC14ChartKLineView24ChevronDownShapeRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView22ChevronUpShapeRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView19CircleShapeRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView17CombinedChartData")
...
/// 自定义画线
@property (nonatomic, strong) CustomDrawChartData * _Null_unspecified customDrawData;
/// 股票对比
@property (nonatomic, strong) LineChartData * _Null_unspecified compareData;
- (void)calcMinMax;
...
@property (nonatomic, readonly, copy) NSArray<ChartData *> * _Nonnull allCalculateData;
...
SWIFT_PROTOCOL("_TtP14ChartKLineView24CompareChartDataProvider_")
@protocol CompareChartDataProvider <BarLineScatterCandleBubbleChartDataProvider>
@property (nonatomic, readonly, strong) LineChartData * _Nullable compareData;
@end


SWIFT_PROTOCOL("_TtP14ChartKLineView27CustomDrawChartDataProvider_")
@protocol CustomDrawChartDataProvider <BarLineScatterCandleBubbleChartDataProvider>
@property (nonatomic, readonly, strong) CustomDrawChartData * _Nullable customDrawData;
@end


SWIFT_PROTOCOL("_TtP14ChartKLineView24ScatterChartDataProvider_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView21LineChartDataProvider_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView25CombinedChartDataProvider_")
@protocol CombinedChartDataProvider <BarChartDataProvider, BubbleChartDataProvider, CandleChartDataProvider, CompareChartDataProvider, CustomDrawChartDataProvider, LineChartDataProvider, ScatterChartDataProvider>
@property (nonatomic, readonly, strong) CombinedChartData * _Nullable combinedData;
@end

@class CombinedChartView;

SWIFT_CLASS("_TtC14ChartKLineView21CombinedChartRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView17CombinedChartView")
...
typedef SWIFT_ENUM_NAMED(NSInteger, CombinedChartDrawOrder, "DrawOrder", closed) {
  ...
  CombinedChartDrawOrderCustom = 5,
  CombinedChartDrawOrderCompare = 6,
};
...
SWIFT_CLASS("_TtC14ChartKLineView21CompareChartDataEntry")
@interface CompareChartDataEntry : ChartDataEntry
/// 用于对比价格计算的y值，一般为当天的开盘价、分时为前一天的收盘价
@property (nonatomic) double compareY;
- (nonnull instancetype)initWithX:(double)x y:(double)y compareY:(double)compareY OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithX:(double)x y:(double)y SWIFT_UNAVAILABLE;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_PROTOCOL("_TtP14ChartKLineView22ILineRadarChartDataSet_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView17ILineChartDataSet_")
...
SWIFT_CLASS("_TtC14ChartKLineView21LineRadarChartDataSet")
...
SWIFT_CLASS("_TtC14ChartKLineView16LineChartDataSet")
...
/// <code>true</code> if drawing the circle-holes is enabled, <code>false</code> ifnot.
@property (nonatomic, readonly) BOOL isDrawCircleHoleEnabled;
/// 高亮时绘制circle, 使用circleRadius和circleColors
@property (nonatomic) BOOL drawHighlightCircleEnabled;
/// 高亮时绘制circleHole, 使用circleHoleRadius和circleHoleColor
@property (nonatomic) BOOL drawHighlightCircleHoleEnabled;
/// This is how much (in pixels) into the dash pattern are we starting from.
@property (nonatomic) CGFloat lineDashPhase;
/// This is the actual dash pattern.
/// I.e. [2, 3] will paint [–   –   ]
...
SWIFT_CLASS("_TtC14ChartKLineView23CompareLineChartDataSet")
@interface CompareLineChartDataSet : LineChartDataSet
@property (nonatomic) double drawScale;
@property (nonatomic, copy) NSDictionary<NSNumber *, ChartDataEntry *> * _Nonnull indexValueMap;
- (nonnull instancetype)initWithEntries:(NSArray<ChartDataEntry *> * _Nullable)entries label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithCompareEntries:(NSArray<CompareChartDataEntry *> * _Nullable)compareEntries label:(NSString * _Nullable)label;
- (nonnull instancetype)initWithCompareEntries:(NSArray<CompareChartDataEntry *> * _Nullable)compareEntries;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (ChartDataEntry * _Nullable)entryForIndex:(NSInteger)i SWIFT_WARN_UNUSED_RESULT;
- (void)calcMinMaxYWithEntry:(ChartDataEntry * _Nonnull)e;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC14ChartKLineView18CrossShapeRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView20CustomChartDataEntry")
@interface CustomChartDataEntry : ChartDataEntry
/// 是否需要在绘制的时候隐藏这个点，比如射线的延长点
@property (nonatomic) BOOL hidingEnable;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithX:(double)x y:(double)y OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithHidingEntry:(double)x y:(double)y OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithData:(NSDictionary<NSString *, id> * _Nonnull)data OBJC_DESIGNATED_INITIALIZER;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end

enum CustomDrawLineType : NSInteger;
enum CustomDrawLineStyle : NSInteger;
@class UIBezierPath;
enum TBLineType : NSInteger;

SWIFT_CLASS("_TtC14ChartKLineView18CustomChartDataSet")
@interface CustomChartDataSet : LineChartDataSet
/// 当前设置的绘制类型
@property (nonatomic) enum CustomDrawLineType customDrawLineType;
/// 当前设置的绘制样式
@property (nonatomic) enum CustomDrawLineStyle customDrawLineStyle;
/// 当前设置的绘制颜色
@property (nonatomic, copy) NSString * _Nonnull customDrawColorString;
/// 默认不选中
@property (nonatomic) BOOL customDrawSelected;
/// 是否需要磁吸
@property (nonatomic) BOOL customDrawMagnetEnable;
/// 计算路径的贝塞尔曲线
@property (nonatomic, copy) NSArray<UIBezierPath *> * _Nonnull customDrawLinePaths;
/// 绘制基于的k线展示类型
@property (nonatomic) enum TBLineType customDrawRelationKlineType;
/// 绘线当前的k线展示类型
@property (nonatomic) enum TBLineType customDrawDisplayKlineType;
/// 默认时间戳为0
@property (nonatomic) double customDrawAddTimeStamp;
/// 默认无时区，只有期货有
@property (nonatomic, copy) NSString * _Nullable customDrawDisplayTimeZoneID;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithEntries:(NSArray<ChartDataEntry *> * _Nullable)entries label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDrawLineType:(enum CustomDrawLineType)drawLineType entries:(NSArray<CustomChartDataEntry *> * _Nullable)entries;
- (nonnull instancetype)initWithData:(NSDictionary<NSString *, id> * _Nonnull)data OBJC_DESIGNATED_INITIALIZER;
/// 设置默认格式的虚线样式
@property (nonatomic, copy) NSArray<NSNumber *> * _Nullable lineDashLengths;
@property (nonatomic) CGFloat circleHoleRadius;
...
@interface CustomChartDataSet (SWIFT_EXTENSION(ChartKLineView))
@property (nonatomic, readonly, strong) UIColor * _Nonnull customDrawColor;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull customDrawTranslateMap;
@property (nonatomic, readonly) NSInteger remainPointCount;
@property (nonatomic, readonly) NSInteger compeletedPointCount;
@property (nonatomic, readonly) double displayKlineTypeTimeDistance;
@property (nonatomic, readonly, copy) NSString * _Nonnull displayKlineTypeDateFormat;
@end
...
SWIFT_CLASS("_TtC14ChartKLineView19CustomChartRenderer")
@interface CustomChartRenderer : LineRadarChartRenderer
@property (nonatomic, weak) id <CustomDrawChartDataProvider> _Nullable dataProvider;
...
SWIFT_CLASS("_TtC14ChartKLineView19CustomDrawChartData")
@interface CustomDrawChartData : ChartData
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDataSets:(NSArray<id <IChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
- (void)addDataSet:(id <IChartDataSet> _Null_unspecified)dataSet;
@property (nonatomic, readonly, copy) NSArray<NSDictionary<NSString *, id> *> * _Nonnull customDrawData;
- (void)generateDispalyDataSets;
- (void)updateDataSetsWithCustomDataSets:(NSArray<id <IChartDataSet>> * _Nonnull)customDataSets;
@end


/// 绘线的设置格式
typedef SWIFT_ENUM(NSInteger, CustomDrawLineStyle, closed) {
  CustomDrawLineStyleLineSolid = 0,
  CustomDrawLineStyleLineSolidArrow = 1,
  CustomDrawLineStyleLineSolidLeftArrow = 2,
  CustomDrawLineStyleLineSolidRightArrow = 3,
  CustomDrawLineStyleLineDotted = 4,
  CustomDrawLineStyleLineDottedArrow = 5,
  CustomDrawLineStyleLineDottedLeftArrow = 6,
  CustomDrawLineStyleLineDottedRightArrow = 7,
};

/// 自定义绘制的类型
typedef SWIFT_ENUM(NSInteger, CustomDrawLineType, closed) {
  CustomDrawLineTypeLineStraight = 0,
  CustomDrawLineTypeLineSegment = 1,
  CustomDrawLineTypeRectangle = 2,
  CustomDrawLineTypeLineVertical = 3,
  CustomDrawLineTypeLineHorizontal = 4,
  CustomDrawLineTypeLineRgression = 5,
  CustomDrawLineTypeLineFibonacciPeriod = 6,
  CustomDrawLineTypeLineRangeStatistic = 7,
};
...
@interface ChartDataApproximator (SWIFT_EXTENSION(ChartKLineView))
...
SWIFT_CLASS("_TtC14ChartKLineView5Entry")
...
@interface ChartHighlight (SWIFT_EXTENSION(ChartKLineView))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC14ChartKLineView26HorizontalBarChartRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView22HorizontalBarChartView")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView16IPieChartDataSet_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView18IRadarChartDataSet_")
...
SWIFT_PROTOCOL("_TtP14ChartKLineView20IScatterChartDataSet_")
...
/// MARK- 横竖屏模式
typedef SWIFT_ENUM_NAMED(NSInteger, TBLandScapeMode, "LandScapeMode", closed) {
  TBLandScapeModePortrait = 0,
  TBLandScapeModeLandScape = 1,
};
...
SWIFT_CLASS("_TtC14ChartKLineView13LineChartData")
...
SWIFT_CLASS("_TtC14ChartKLineView17LineChartRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView13LineChartView")
...
typedef SWIFT_ENUM_NAMED(NSInteger, TBLineType, "LineType", closed) {
  TBLineTypeTrend1Minute = 0,
  TBLineTypeCandle1Minute = 1,
  TBLineTypeCandle3Minute = 2,
  TBLineTypeCandle5Minute = 3,
  TBLineTypeCandle10Minute = 4,
  TBLineTypeCandle15Minute = 5,
  TBLineTypeCandle30Minute = 6,
  TBLineTypeCandle45Minute = 7,
  TBLineTypeCandle1Hour = 8,
  TBLineTypeCandle2Hour = 9,
  TBLineTypeCandle3Hour = 10,
  TBLineTypeCandle4Hour = 11,
  TBLineTypeCandle6Hour = 12,
  TBLineTypeCandle1Day = 13,
  TBLineTypeCandle1Week = 14,
  TBLineTypeCandle1Month = 15,
  TBLineTypeCandle1Year = 16,
  TBLineTypeAll = 17,
  TBLineTypeRealTime1Day = 18,
  TBLineTypeRealTime5Day = 19,
  TBLineTypePeriodOneMonthCandle1Hour = 20,
  TBLineTypePeriodThreeMonthCandle1Day = 21,
  TBLineTypePeriodSixMonthCandle1Day = 22,
  TBLineTypePeriodThisYearCandle1Week = 23,
  TBLineTypePeriodOneYearCandle1Week = 24,
  TBLineTypePeriodFiveYearCandle1Month = 25,
  TBLineTypeCandle2Minute = 26,
  TBLineTypeCandle1Quarter = 27,
  TBLineTypeBondOneMonth = 28,
  TBLineTypeBondThreeMonth = 29,
  TBLineTypeBondOneYear = 30,
  TBLineTypeBondThreeYear = 31,
};
...
SWIFT_CLASS("_TtC14ChartKLineView24NSUIAccessibilityElement")
...
@interface NSUIView (SWIFT_EXTENSION(ChartKLineView))
...
SWIFT_CLASS("_TtC14ChartKLineView12PieChartData")
...
SWIFT_CLASS("_TtC14ChartKLineView17PieChartDataEntry")
...
SWIFT_CLASS("_TtC14ChartKLineView15PieChartDataSet")
...
SWIFT_CLASS("_TtC14ChartKLineView16PieChartRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView21PieRadarChartViewBase")
...
SWIFT_CLASS("_TtC14ChartKLineView12PieChartView")
...
SWIFT_CLASS("_TtC14ChartKLineView14RadarChartData")
...
SWIFT_CLASS("_TtC14ChartKLineView19RadarChartDataEntry")
...
SWIFT_CLASS("_TtC14ChartKLineView17RadarChartDataSet")
...
SWIFT_CLASS("_TtC14ChartKLineView18RadarChartRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView14RadarChartView")
...
SWIFT_CLASS("_TtC14ChartKLineView16ScatterChartData")
...
SWIFT_CLASS("_TtC14ChartKLineView19ScatterChartDataSet")
...
SWIFT_CLASS("_TtC14ChartKLineView20ScatterChartRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView16ScatterChartView")
...
SWIFT_CLASS("_TtC14ChartKLineView19SquareShapeRenderer")
...
SWIFT_CLASS("_TtC14ChartKLineView25StockCompareChartRenderer")
@interface StockCompareChartRenderer : LineRadarChartRenderer
@property (nonatomic, weak) id <CompareChartDataProvider> _Nullable dataProvider;
- (nonnull instancetype)initWithDataProvider:(id <CompareChartDataProvider> _Nonnull)dataProvider animator:(ChartAnimator * _Nonnull)animator viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef _Nonnull)context dataSet:(id <ILineChartDataSet> _Nonnull)dataSet;
- (void)drawLinearWithContext:(CGContextRef _Nonnull)context dataSet:(id <ILineChartDataSet> _Nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef _Nonnull)context;
...
/// MARK- 图表绘制市场类型
typedef SWIFT_ENUM_NAMED(NSInteger, TBChartDrawMarketType, "StockDrawType", closed) {
  TBChartDrawMarketTypeCommon = 0,
  TBChartDrawMarketTypeUS = 1,
  TBChartDrawMarketTypeHK = 2,
  TBChartDrawMarketTypeCN = 3,
  TBChartDrawMarketTypeOption = 4,
  TBChartDrawMarketTypeOptionDefault = 5,
  TBChartDrawMarketTypePreMarket = 6,
  TBChartDrawMarketTypeSufMarket = 7,
  TBChartDrawMarketTypeFutures = 8,
  TBChartDrawMarketTypeUK = 9,
  TBChartDrawMarketTypeAStockSufMarket = 10,
  TBChartDrawMarketTypeSI = 11,
  TBChartDrawMarketTypeAU = 12,
  TBChartDrawMarketTypeNZ = 13,
  TBChartDrawMarketTypeDigitalCurrency = 14,
  TBChartDrawMarketTypeUSTotalMarket = 15,
  TBChartDrawMarketTypeBond = 16,
  TBChartDrawMarketTypeBonds = 17,
  TBChartDrawMarketTypeForex = 18,
  TBChartDrawMarketTypeOverNight = 19,
};

/// 策略助手
typedef SWIFT_ENUM_NAMED(NSInteger, TBStockStrategyType, "StockStrategyType", closed) {
  TBStockStrategyTypeNone = 0,
  TBStockStrategyTypeZigZag = 1,
};


SWIFT_CLASS("_TtC14ChartKLineView12TBCalculator")
@interface TBCalculator : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) TBCalculator * _Nonnull shareInstance;)
+ (TBCalculator * _Nonnull)shareInstance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC14ChartKLineView11TBExproNode")
@interface TBExproNode : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC14ChartKLineView13TBResultEntry")
@interface TBResultEntry : Entry
@end


/// 股票技术指标参数
SWIFT_CLASS("_TtC14ChartKLineView17TBStockTechParams")
@interface TBStockTechParams : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
/// 解析k线的指标参数
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSDictionary<NSString *, NSArray<NSDictionary<NSString *, id> *> *> * _Nonnull paramsDict;)
+ (NSDictionary<NSString *, NSArray<NSDictionary<NSString *, id> *> *> * _Nonnull)paramsDict SWIFT_WARN_UNUSED_RESULT;
/// 获取指标的值设置
+ (NSArray<NSNumber *> * _Nonnull)indicatorValuesForKey:(NSString * _Nonnull)forKey SWIFT_WARN_UNUSED_RESULT;
/// 修改单例属性
+ (void)changeStockIndicatorParamsWithDic:(NSDictionary<NSString *, NSArray<NSDictionary<NSString *, id> *> *> * _Nonnull)dic;
/// 保存指标更新，顺便更新单例属性
+ (void)saveStockIndicatorParamsWithDic:(NSDictionary<NSString *, NSArray<NSDictionary<NSString *, id> *> *> * _Nonnull)dic;
/// 取出缓存的k线指标
+ (NSDictionary<NSString *, NSArray<NSDictionary<NSString *, id> *> *> * _Nonnull)klineIndicatorParams SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSArray<NSDictionary<NSString *, id> *> *> * _Nonnull)getDefaultParameters SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC14ChartKLineView7TBToken")
@interface TBToken : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM_NAMED(NSInteger, TCTILengendShape, "TCTIShape", closed) {
  TCTILengendShapeSquare = 0,
  TCTILengendShapeCircle = 1,
  TCTILengendShapeTriangle = 2,
  TCTILengendShapeNone = 3,
};
...
SWIFT_CLASS("_TtC14ChartKLineView21TriangleShapeRenderer")
...
@interface UIFont (SWIFT_EXTENSION(ChartKLineView))
+ (UIFont * _Nonnull)tb_numberFontOfSize:(CGFloat)ofSize SWIFT_WARN_UNUSED_RESULT;
@end


@interface UIPanGestureRecognizer (SWIFT_EXTENSION(ChartKLineView))
...
@interface UIPinchGestureRecognizer (SWIFT_EXTENSION(ChartKLineView))
...
@interface UITapGestureRecognizer (SWIFT_EXTENSION(ChartKLineView))
- (NSInteger)nsuiNumberOfTouches SWIFT_WARN_UNUSED_RESULT;
...
@interface ChartViewPortHandler (SWIFT_EXTENSION(ChartKLineView))
@property (nonatomic) NSInteger maxScale;
@property (nonatomic) enum TBLandScapeMode landScapeMode;
@property (nonatomic) float preClose;
@property (nonatomic) enum TBChartDrawMarketType drawMarket;
@property (nonatomic) enum TBLineType lineType;
...
@interface ChartXAxis (SWIFT_EXTENSION(ChartKLineView))
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull xAxisValues;
@end
...
SWIFT_CLASS("_TtC14ChartKLineView31XAxisRendererHorizontalBarChart")
...
SWIFT_CLASS("_TtC14ChartKLineView23XAxisRendererRadarChart")
...
SWIFT_CLASS("_TtC14ChartKLineView14XShapeRenderer")
...
@interface ChartYAxis (SWIFT_EXTENSION(ChartKLineView))
@property (nonatomic, strong) NSNumberFormatter * _Nonnull numberFormatter;
...
SWIFT_CLASS("_TtC14ChartKLineView31YAxisRendererHorizontalBarChart")
...
SWIFT_CLASS("_TtC14ChartKLineView23YAxisRendererRadarChart")
...
typedef SWIFT_ENUM_NAMED(NSInteger, TBKLineChartYAxisType, "YAxisType", closed) {
  TBKLineChartYAxisTypeMA = 0,
  TBKLineChartYAxisTypeBOLL = 1,
  TBKLineChartYAxisTypeEMA = 2,
  TBKLineChartYAxisTypeSAR = 3,
  TBKLineChartYAxisTypeTCTI = 4,
  TBKLineChartYAxisTypeBBI = 5,
  TBKLineChartYAxisTypeHMA = 6,
  TBKLineChartYAxisTypeLMA = 7,
  TBKLineChartYAxisTypeVMA = 8,
  TBKLineChartYAxisTypeBBIBOLL = 9,
  TBKLineChartYAxisTypeALLIGAT = 10,
  TBKLineChartYAxisTypePBX = 11,
  TBKLineChartYAxisTypeENE = 12,
  TBKLineChartYAxisTypeMIKE = 13,
  TBKLineChartYAxisTypeXT = 14,
  TBKLineChartYAxisTypeJAX = 15,
  TBKLineChartYAxisTypeVOLUME = 16,
  TBKLineChartYAxisTypeMACD = 17,
  TBKLineChartYAxisTypeKDJ = 18,
  TBKLineChartYAxisTypeRSI = 19,
  TBKLineChartYAxisTypeARBR = 20,
  TBKLineChartYAxisTypeOBV = 21,
  TBKLineChartYAxisTypeDMI = 22,
  TBKLineChartYAxisTypeWR = 23,
  TBKLineChartYAxisTypeEMV = 24,
  TBKLineChartYAxisTypeDMA = 25,
  TBKLineChartYAxisTypeCCI = 26,
  TBKLineChartYAxisTypeMFI = 27,
  TBKLineChartYAxisTypeLINE = 28,
  TBKLineChartYAxisTypeCOMPARE = 29,
/// add:叠加比较type，用了处理叠加
  TBKLineChartYAxisTypeATR = 30,
  TBKLineChartYAxisTypeTRIX = 31,
  TBKLineChartYAxisTypeOIV = 32,
  TBKLineChartYAxisTypeVR = 33,
  TBKLineChartYAxisTypeTPXH = 34,
  TBKLineChartYAxisTypeMACDKDJ = 35,
  TBKLineChartYAxisTypeBIAS = 36,
  TBKLineChartYAxisTypeDKX = 37,
  TBKLineChartYAxisTypePCNT = 38,
  TBKLineChartYAxisTypeROC = 39,
  TBKLineChartYAxisTypeSKDJ = 40,
  TBKLineChartYAxisTypeUDL = 41,
  TBKLineChartYAxisTypeVRSI = 42,
  TBKLineChartYAxisTypeWAD = 43,
  TBKLineChartYAxisTypeXS = 44,
  TBKLineChartYAxisTypeIV = 45,
  TBKLineChartYAxisTypeOPENINT = 46,
  TBKLineChartYAxisTypeNone = 47,
  TBKLineChartYAxisTypeZigZag = 48,
  TBKLineChartYAxisTypeMTM = 49,
  TBKLineChartYAxisTypeADTM = 50,
  TBKLineChartYAxisTypeCR = 51,
  TBKLineChartYAxisTypeWVAD = 52,
  TBKLineChartYAxisTypeUnChecked = 53,
};
