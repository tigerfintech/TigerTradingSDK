...
@class TBKBaseNavigator;

@protocol TBKNavigatorDelegate <NSObject>
@optional
 ...
 */
- (BOOL)navigator:(TBKBaseNavigator*)navigator shouldOpenURL:(NSURL*)URL;
 ...
 */
- (NSURL*)navigator:(TBKBaseNavigator*)navigator URLToOpen:(NSURL*)URL;
 ...
 */
- (void)navigator:(TBKBaseNavigator*)navigator willOpenURL:(NSURL*)URL
