 ...
 */
@interface TBKEntityTables : NSObject {
...
@interface TBKEntityTables (TBKSingleton)

// Access the singleton instance: [[TBKEntityTables sharedInstance] <methods>]
+ (TBKEntityTables*)sharedInstance;
