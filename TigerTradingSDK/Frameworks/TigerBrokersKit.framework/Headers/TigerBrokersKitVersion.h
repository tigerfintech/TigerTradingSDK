...
/**
 * General-purpose information about the TigerBrokersKit ecosystem.
 *
 * This information is present in the core because TigerBrokersKit versioning is done across all of
 * the primary TigerBrokersKit modules.
 *
 * This is the only object in the TigerBrokersKit ecosystem that doesn't follow the standard TT* prefix.
 * This is by design. [TigerBrokersKit version] is much clearer than [TTVersion version].
 */
@interface TigerBrokersKit : NSObject
