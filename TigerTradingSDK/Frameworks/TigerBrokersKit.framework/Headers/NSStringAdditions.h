 ...
 */
@interface NSString (TBKAdditions)
 ...
 * @deprecated Use TBKIsStringWithAnyText() instead. Updating your use of
 ...
 * becomes
 *
 * if (TBKIsStringWithAnyText(textField.text) && !textField.text.isWhitespaceAndNewlines) {
 *
 * and
 *
 * if (textField.text.isEmptyOrWhitespace) {
 ...
 */
- (BOOL)isEmptyOrWhitespace __TBKDEPRECATED_METHOD;
 ...
 */
- (NSDictionary*)queryDictionaryUsingEncoding:(NSStringEncoding)encoding __TBKDEPRECATED_METHOD;
