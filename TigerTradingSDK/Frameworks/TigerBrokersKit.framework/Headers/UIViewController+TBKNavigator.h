...
@interface UIViewController (TBKNavigator)

/**
 * The default initializer sent to view controllers opened through TBKNavigator.
 */
...
/**
 * The URL that was used to load this controller through TBKNavigator.
 *
 * Do not ever change the value of this property.  TBKNavigator will assign this
 ...
 *
 * While restoring controllers, TBKURLMap will assign this the dictionary created by persistView.
