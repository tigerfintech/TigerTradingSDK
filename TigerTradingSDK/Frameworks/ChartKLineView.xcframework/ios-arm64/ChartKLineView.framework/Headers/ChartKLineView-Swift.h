...
/// 绘线的设置格式
typedef SWIFT_ENUM(NSInteger, CustomDrawLineStyle, open) {
...
/// 自定义绘制的类型
typedef SWIFT_ENUM(NSInteger, CustomDrawLineType, open) {
...
/// MARK- 横竖屏模式
typedef SWIFT_ENUM_NAMED(NSInteger, TBLandScapeMode, "LandScapeMode", open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, TBLineType, "LineType", open) {
...
/// MARK- 图表绘制市场类型
typedef SWIFT_ENUM_NAMED(NSInteger, TBChartDrawMarketType, "StockDrawType", open) {
...
/// 策略助手
typedef SWIFT_ENUM_NAMED(NSInteger, TBStockStrategyType, "StockStrategyType", open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, TCTILengendShape, "TCTIShape", open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, TBKLineChartYAxisType, "YAxisType", open) {
