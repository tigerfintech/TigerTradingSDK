...
SWIFT_CLASS("_TtC16TBSwiftComponent24TBCustomChartYAxisRender")
...
typedef SWIFT_ENUM_NAMED(NSInteger, TBDateFormatterStyle, "DateFormatterStyle", closed) {
...
SWIFT_CLASS("_TtC16TBSwiftComponent31TBPlaceOrderPnLChartYAxisRender")
...
typedef SWIFT_ENUM_NAMED(NSInteger, TBPortfolioTabIndex, "TBPortfolioTabIndex", closed) {
...
typedef SWIFT_ENUM(NSInteger, TBStockProLiteIndicatorPeriod, closed) {
...
typedef SWIFT_ENUM(NSInteger, TBTabBarIndex, closed) {
  TBTabBarIndexHome = 0,
