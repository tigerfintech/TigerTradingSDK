...
// baas_auth
static NSString *BAAS_AUTH_SERVER_KEY                   = @"baas-auth";
static inline NSString *TEST_BAAS_AUTH_SERVER_KEY(void) {
    NSString *key = @"test_baas-auth";
    return processedTestQAXServerKey(key);
}

// baas_auth
static NSString *BAAS_TRADE_SERVER_KEY                   = @"baas-trade";
static inline NSString *TEST_BAAS_TRADE_SERVER_KEY(void) {
    NSString *key = @"test_baas-trade";
    return processedTestQAXServerKey(key);
}
