...
@interface TBTigerTradeDataPlatformHost : TBTigerTradeBaseConfig <TBHostConfig>
@end

@interface TBSDKBaasAuthHost : TBTigerTradeBaseConfig <TBHostConfig>
@end

@interface TBSDKBaasTradeHost : TBTigerTradeBaseConfig <TBHostConfig>
@end
