...
static NSString *BROKER_OPENID_KEY                                                                     = @"open_id";
static NSString *BROKER_ACCESS_TOKEN                                                                     = @"broker_access_token";
...
static NSString *USER_DEFAULT_STOCK_BROKER_ACCESS_TOKEN_KEY                                                                     = @"tigerbroker_ocid_access_token";
