...
#import "TigerBrokersKit/TBKBaseNavigator.h"

/**
 * Shortcut for calling [[TBKNavigator navigator] openURL:]
 */
UIViewController* TBKOpenURL(NSString* URL);

/**
 * Shortcut for calling [[TTBaseNavigator navigatorForView:view] openURL:]
 */
UIViewController* TBKOpenURLFromView(NSString* URL, UIView* view);
 ...
 */
@interface TBKNavigator : TBKBaseNavigator {
}

+ (TBKNavigator*)navigator;
