 ...
 * has started running.
 *
 *     [TBKExtensionLoader loadAllExtensions];
 *
 * is likely the only method you'll need to use.
 *
 * How it works:
 *
 * An extension creates a TBKExtensionLoader category, e.g.:
 *
 *     @interface TBKExtensionLoader (TTXMLExtension)
 *
 ...
 *
 *     - (TBKExtensionInfo*)extensionInfoNamedThree20XML;
 *
 * This method should return an autoreleased TBKExtensionInfo object that has been populated with
 * any information the extension wishes to provide. If this method isn't implemented, a default
 * TBKExtensionInfo object will be created.
 */
@interface TBKExtensionLoader : NSObject {
 ...
 *
 * Format:
 *  [(NSString*)identifier] => (TBKExtensionInfo*)extension
 */
