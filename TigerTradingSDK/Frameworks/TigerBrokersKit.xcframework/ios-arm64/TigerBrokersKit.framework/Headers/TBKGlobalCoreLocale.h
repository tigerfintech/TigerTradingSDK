 ...
 */
NSLocale* TBKCurrentLocale(void);

/**
 * @return A localized string from the Three20 bundle.
 */
NSString* TBKLocalizedString(NSString* key, NSString* comment);
 ...
 */
NSString* TBKDescriptionForError(NSError* error);
 ...
 */
NSString* TBKFormatInteger(NSInteger num);
NSString* TBKFormatFloating(CGFloat num);
NSString* TBKFormatNumber(NSNumber *num);
