...
// Network
#import "TigerBrokersKit/TTModel.h"
#import "TigerBrokersKit/TBKURLRequestDelegate.h"
 ...
 */
@interface TTURLRequestModel : TTModel <TBKURLRequestDelegate> {
    TBKURLRequest* _loadingRequest;
