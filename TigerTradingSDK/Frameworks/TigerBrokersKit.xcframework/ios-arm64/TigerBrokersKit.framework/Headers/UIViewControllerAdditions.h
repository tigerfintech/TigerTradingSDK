...
@interface UIViewController (TBKCategory)
 ...
 * custom UIViewController subclasses the chance to tell TBKNavigator how to follow the hierarchy
 * of view controllers.
 */
@property (nonatomic, strong) UIViewController* superController; // 应该可以weak
 ...
 * subclasses the chance to tell TBKNavigator how to follow the hierarchy of view controllers.
 */
 ...
 */
@property (nonatomic, strong) UIViewController* popupViewController; // 应该可以weak

/**
 * Displays a controller inside this controller.
 *
 * TBKURLMap uses this to display newly created controllers.  The default does nothing --
 ...
 *
 * TBKURLMap uses this to display controllers that exist already, but may not be visible.
 ...
 *
 * This will be called when TBKNavigator is persisting the navigation history so that it
 ...
 *
 * This will be called when TBKNavigator is restoring the navigation history.  This may
...
/**
 * Finishes initializing the controller after a TBKNavigator-coordinated delay.
 *
 * If the controller was created in between calls to TBKNavigator beginDelay and endDelay, then
