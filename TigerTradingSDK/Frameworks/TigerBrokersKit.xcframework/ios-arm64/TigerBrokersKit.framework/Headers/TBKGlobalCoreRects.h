 ...
 */
CGRect TBKRectContract(CGRect rect, CGFloat dx, CGFloat dy);
 ...
 */
CGRect TBKRectShift(CGRect rect, CGFloat dx, CGFloat dy);
 ...
 */
CGRect TBKRectInset(CGRect rect, UIEdgeInsets insets);
