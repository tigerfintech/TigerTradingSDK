...
@class TBKURLNavigatorPattern;
@class TBKURLGeneratorPattern;

@interface TBKURLMap : NSObject {
    ...
    TBKURLNavigatorPattern*  _defaultObjectPattern;
    TBKURLNavigatorPattern*  _hashPattern;
...
- (id)objectForURL:(NSString*)URL query:(NSDictionary*)query
           pattern:(TBKURLNavigatorPattern**)pattern;
 ...
 */
- (TBKNavigationMode)navigationModeForURL:(NSString*)URL; // 废弃. TBKNavigationMode 已经改为是action的属性, 无法再从pattern中获取.
