//
//  TBCollectionViewWaterfallLayout.h
//  Stock
//
//  Created by dulijun on 2019/4/29.
 ...
 */
typedef NS_ENUM (NSUInteger, TBCollectionViewWaterfallLayoutItemRenderDirection) {
    TBCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst,
    TBCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight,
    TBCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft
};
...
extern NSString *const TBCollectionElementKindSectionHeader;
/// A supplementary view that identifies the footer for a given section.
extern NSString *const TBCollectionElementKindSectionFooter;

#pragma mark - TBCollectionViewDelegateWaterfallLayout

@class TBCollectionViewWaterfallLayout;

/**
 *  The TBCollectionViewDelegateWaterfallLayout protocol defines methods that let you coordinate with a
 *  TBCollectionViewWaterfallLayout object to implement a waterfall-based layout.
 ...
 */
@protocol TBCollectionViewDelegateWaterfallLayout <UICollectionViewDelegate>
@required
/**
...
#pragma mark - TBCollectionViewWaterfallLayout

/**
 *  The TBCollectionViewWaterfallLayout class is a concrete layout object that organizes items into waterfall-based grids
 ...
 *  in each section. That delegate object must conform to the `TBCollectionViewDelegateWaterfallLayout` protocol.
 *
 ...
 *
 *  @note TBCollectionViewWaterfallLayout doesn't support decoration view, and it supports vertical scrolling direction only.
 
 */
@interface TBCollectionViewWaterfallLayout : UICollectionViewLayout
 ...
 *  @discussion
 *    The direction in which each item is rendered. This could be left to right (TBCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight), right to left (TBCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft), or shortest column fills first (TBCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst).
 *
 *    Default: TBCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst
 */
@property (nonatomic, assign) TBCollectionViewWaterfallLayoutItemRenderDirection itemRenderDirection;
