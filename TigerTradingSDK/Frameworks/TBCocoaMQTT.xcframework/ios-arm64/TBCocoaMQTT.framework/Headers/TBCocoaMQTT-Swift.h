...
#ifndef TBCOCOAMQTT_SWIFT_H
#define TBCOCOAMQTT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TBCocoaMQTT",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11TBCocoaMQTT9CocoaMQTT")
...
/// note:
/// MGCDAsyncSocket need delegate to extend NSObject
SWIFT_CLASS("_TtC11TBCocoaMQTT10CocoaMQTT5")
...
/// CocoaMQTT5 Delegate
SWIFT_PROTOCOL("_TtP11TBCocoaMQTT18CocoaMQTT5Delegate_")
...
/// MQTT Message
SWIFT_CLASS("_TtC11TBCocoaMQTT17CocoaMQTT5Message")
...
@interface CocoaMQTT5Message (SWIFT_EXTENSION(TBCocoaMQTT))
...
/// CocoaMQTT Delegate
SWIFT_PROTOCOL("_TtP11TBCocoaMQTT17CocoaMQTTDelegate_")
...
SWIFT_CLASS("_TtC11TBCocoaMQTT15CocoaMQTTLogger")
...
/// MQTT Message
SWIFT_CLASS("_TtC11TBCocoaMQTT16CocoaMQTTMessage")
...
@interface CocoaMQTTMessage (SWIFT_EXTENSION(TBCocoaMQTT))
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
...
SWIFT_CLASS("_TtC11TBCocoaMQTT15CocoaMQTTSocket")
...
@interface CocoaMQTTSocket (SWIFT_EXTENSION(TBCocoaMQTT)) <MGCDAsyncSocketDelegate>
...
SWIFT_CLASS("_TtC11TBCocoaMQTT18MqttAuthProperties")
@interface MqttAuthProperties : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11TBCocoaMQTT21MqttConnectProperties")
@interface MqttConnectProperties : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11TBCocoaMQTT17MqttDecodeConnAck")
@interface MqttDecodeConnAck : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11TBCocoaMQTT16MqttDecodePubAck")
@interface MqttDecodePubAck : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11TBCocoaMQTT17MqttDecodePubComp")
@interface MqttDecodePubComp : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11TBCocoaMQTT16MqttDecodePubRec")
@interface MqttDecodePubRec : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11TBCocoaMQTT16MqttDecodePubRel")
@interface MqttDecodePubRel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11TBCocoaMQTT17MqttDecodePublish")
@interface MqttDecodePublish : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11TBCocoaMQTT16MqttDecodeSubAck")
@interface MqttDecodeSubAck : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11TBCocoaMQTT18MqttDecodeUnsubAck")
@interface MqttDecodeUnsubAck : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11TBCocoaMQTT21MqttPublishProperties")
...
@protocol TBCocoaMqttClientDelegate;

SWIFT_PROTOCOL("_TtP11TBCocoaMQTT17TBCocoaMqttClient_")
@protocol TBCocoaMqttClient
- (void)subscribeTopicWithTopic:(NSString * _Nonnull)topic userProperty:(NSDictionary<NSString *, NSString *> * _Nullable)userProperty;
- (void)unsubscribeWithTopic:(NSString * _Nonnull)topic userProperty:(NSDictionary<NSString *, NSString *> * _Nullable)userProperty;
- (void)subscribeTopicsWithTopics:(NSArray<NSString *> * _Nonnull)topics userProperty:(NSDictionary<NSString *, NSString *> * _Nullable)userProperty;
- (void)unsubscribeWithTopics:(NSArray<NSString *> * _Nonnull)topics userProperty:(NSDictionary<NSString *, NSString *> * _Nullable)userProperty;
/// 发布消息
/// \param responseTopic responseTopic description
///
/// \param topicPayload topicPayload description
///
/// \param correlationData correlationData description
///
/// \param userProperty userProperty description
///
///
/// returns:
/// description
- (NSInteger)publish:(NSString * _Nonnull)topic responseTopic:(NSString * _Nonnull)responseTopic topicPayload:(NSDictionary<NSString *, id> * _Nonnull)topicPayload correlationData:(NSString * _Nonnull)correlationData userProperty:(NSDictionary<NSString *, NSString *> * _Nullable)userProperty SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)publish:(NSString * _Nonnull)topic responseTopic:(NSString * _Nonnull)responseTopic correlationData:(NSString * _Nonnull)correlationData message:(CocoaMQTTMessage * _Nonnull)message userProperty:(NSDictionary<NSString *, NSString *> * _Nullable)userProperty SWIFT_WARN_UNUSED_RESULT;
- (BOOL)connect SWIFT_WARN_UNUSED_RESULT;
- (BOOL)connectWithTimeout:(NSTimeInterval)timeout SWIFT_WARN_UNUSED_RESULT;
- (void)disconnect;
- (void)ping;
@property (nonatomic, strong) id <TBCocoaMqttClientDelegate> _Nullable delegate;
@end


SWIFT_PROTOCOL("_TtP11TBCocoaMQTT25TBCocoaMqttClientDelegate_")
@protocol TBCocoaMqttClientDelegate
/// MQTT 链接状态
/// \param mqtt mqtt description
///
/// \param state state description
///
- (void)mqtt:(id <TBCocoaMqttClient> _Nonnull)mqtt didStateChangeTo:(enum CocoaMQTTConnState)state;
- (void)mqtt:(id <TBCocoaMqttClient> _Nonnull)mqtt didPublishStateChangeTo:(enum CocoaMQTTConnState)state;
/// 接收信息
...
///
/// \param publishData publishData description
///
- (void)mqtt:(id <TBCocoaMqttClient> _Nonnull)mqtt didReceiveMessage:(CocoaMQTT5Message * _Nonnull)message id:(uint16_t)id publishData:(MqttDecodePublish * _Nullable)publishData;
/// 接收到publish 消息
/// \param mqtt mqtt description
///
/// \param message message description
...
/// \param publishData publishData description
///
- (void)mqtt:(id <TBCocoaMqttClient> _Nonnull)mqtt didReceivePublishMessage:(CocoaMQTT5Message * _Nonnull)message id:(uint16_t)id publishData:(MqttDecodePublish * _Nullable)publishData;
@end


SWIFT_CLASS("_TtC11TBCocoaMQTT20TBMqttClient5Manager")
@interface TBMqttClient5Manager : NSObject
@property (nonatomic, strong) id <TBCocoaMqttClientDelegate> _Nullable delegate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface TBMqttClient5Manager (SWIFT_EXTENSION(TBCocoaMQTT)) <CocoaMQTTDelegate>
- (void)mqtt:(CocoaMQTT * _Nonnull)mqtt didStateChangeTo:(enum CocoaMQTTConnState)state;
- (void)mqtt:(CocoaMQTT * _Nonnull)mqtt didConnectAck:(enum CocoaMQTTConnAck)ack;
- (void)mqtt:(CocoaMQTT * _Nonnull)mqtt didPublishMessage:(CocoaMQTTMessage * _Nonnull)message id:(uint16_t)id;
- (void)mqtt:(CocoaMQTT * _Nonnull)mqtt didPublishAck:(uint16_t)id;
...
@interface TBMqttClient5Manager (SWIFT_EXTENSION(TBCocoaMQTT)) <CocoaMQTT5Delegate>
///
- (void)mqtt5:(CocoaMQTT5 * _Nonnull)mqtt5 didConnectAck:(enum CocoaMQTTCONNACKReasonCode)ack connAckData:(MqttDecodeConnAck * _Nullable)connAckData;
///
- (void)mqtt5:(CocoaMQTT5 * _Nonnull)mqtt5 didPublishMessage:(CocoaMQTT5Message * _Nonnull)message id:(uint16_t)id;
...
@interface TBMqttClient5Manager (SWIFT_EXTENSION(TBCocoaMQTT)) <TBCocoaMqttClient>
- (void)subscribeTopicWithTopic:(NSString * _Nonnull)topic userProperty:(NSDictionary<NSString *, NSString *> * _Nullable)userProperty;
- (void)unsubscribeWithTopic:(NSString * _Nonnull)topic userProperty:(NSDictionary<NSString *, NSString *> * _Nullable)userProperty;
- (void)subscribeTopicsWithTopics:(NSArray<NSString *> * _Nonnull)topics userProperty:(NSDictionary<NSString *, NSString *> * _Nullable)userProperty;
- (void)unsubscribeWithTopics:(NSArray<NSString *> * _Nonnull)topics userProperty:(NSDictionary<NSString *, NSString *> * _Nullable)userProperty;
...
- (NSInteger)publish:(NSString * _Nonnull)topic responseTopic:(NSString * _Nonnull)responseTopic correlationData:(NSString * _Nonnull)correlationData message:(CocoaMQTTMessage * _Nonnull)message userProperty:(NSDictionary<NSString *, NSString *> * _Nullable)userProperty SWIFT_WARN_UNUSED_RESULT;
- (BOOL)connect SWIFT_WARN_UNUSED_RESULT;
- (BOOL)subscribeConnect SWIFT_WARN_UNUSED_RESULT;
- (BOOL)publishConnect SWIFT_WARN_UNUSED_RESULT;
- (BOOL)subscribeConnectWithTimeout:(NSTimeInterval)timeout SWIFT_WARN_UNUSED_RESULT;
- (BOOL)publishConnectWithTimeout:(NSTimeInterval)timeout SWIFT_WARN_UNUSED_RESULT;
- (BOOL)connectWithTimeout:(NSTimeInterval)timeout SWIFT_WARN_UNUSED_RESULT;
- (void)disconnect;
...
SWIFT_CLASS("_TtC11TBCocoaMQTT12TBMqttConfig")
@interface TBMqttConfig : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
